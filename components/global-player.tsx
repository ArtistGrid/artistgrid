    ...
    >
      ...
      >
        <Button
          ...
          size="icon"
          onClick={onClose}
          className="absolute top-3 right-3 text-neutral-500 hover:text-white h-8 w-8 rounded-lg z-10"
        >
          <X className="w-5 h-5" />
        </Button>
        ...
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="bg-white text-black hover:bg-neutral-200 rounded-full w-11 h-11"
            >
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <input
              ...
              className="w-20 h-1 bg-neutral-800 rounded cursor-pointer accent-white"
            />
          </div>
          <Button
            variant="ghost"
            ...
            className={`rounded-lg w-9 h-9 relative ${state.queue.length > 0 ? "text-white hover:bg-white/10" : "text-neutral-500 hover:text-white hover:bg-white/10"}`}
          >
          ...
          <Button
            ...
            size="icon"
            onClick={handleClose}
            className="text-neutral-500 hover:text-white hover:bg-white/10 rounded-lg w-9 h-9"
          >
            <X className="w-4 h-4" />
          </Button>
        </div>
