...
describe("image-resolve", () => {
  ...
  it("syncImageUrl wraps ibb images with wsrv.nl", () => {
    ...
    expect(syncImageUrl("https://i.ibb.co/abc123/image.jpg")).toBe(
      "https://wsrv.nl/?url=https://i.ibb.co/abc123/image.jpg"
    );
    expect(syncImageUrl("https://i.ibb.co/abc123/full.png")).toBe(
  ...
  it("toWsrvUrl does not double wrap wsrv urls", () => {
    expect(toWsrvUrl("https://wsrv.nl/?url=https://i.ibb.co/x.jpg")).toBe(
      "https://wsrv.nl/?url=https://i.ibb.co/x.jpg"
    );
