            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-6 sm:px-12 pb-8 pt-16">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <Button
                  ...
                  className={`hover:bg-white/10 rounded-full w-10 h-10 sm:w-12 sm:h-12 transition-colors active:scale-90 ${state.isShuffled ? "text-white" : "text-white/40 hover:text-white"}`}
                  aria-label="Shuffle"
                ...
                <Button
                  ...
                  className={`hover:bg-white/10 rounded-full w-10 h-10 sm:w-12 sm:h-12 transition-colors active:scale-90 ${state.repeatMode !== "off" ? "text-white" : "text-white/40 hover:text-white"}`}
